...
function timeout() { 
 deleteMarkers();
 downloadUrl("phpsqlajax_genxml3_tracking_orden_trabajo.php?DID=<?php echo $DEVICEID;?>", function(data) {
        ...
        var markers = xml.documentElement.getElementsByTagName("marker");
		 ...
		 for (var i = 0; i < markers.length; i++) {	
                          ...
                          var estatus = markers[i].getAttribute("estatus");
  ...
  if(speed>0) var status=Math.round(speed*1.852) + " moving"; else var status="stop"; // moving status according to speed
 
  if (estatus=='Activo') 

  var html ='<div style="margin:1px !important; font-size:12px;">Nombre del Conductor :' + "<b>" + nombre + "</b> <br/>Angulo : " + course + "<br/> Última actualización : " + time + "<br/> Acc : " + Acc + "<br/> Velocidad : " + Math.round(speed*1.852) + " kmph<br/>Lat : " + Lat + "<br/>Lng : " + Lng + "<br/>Tipo Vehiculo : " + dt_name + "<br/>Orden de Trabajo : "+ "<b>" + descripcion + "</b> <br/>Direccion de la Orden: " + direccion + "<br/>Telefono Conductor : "+ "<b>" + telefono + "</b> <br/>Numero de Orden : "+ "<b>" + id + "</b> <br/>Estatus : "+ "<b>" + estatus + "</b> <br/>" + '</div>' ;
