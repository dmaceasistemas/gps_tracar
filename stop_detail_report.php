...
<table width="100%" border="0">
  <tr>
    <td bgcolor="#000000"><div style="color:#FFF; font-weight:bold; background:url(images/top_bg.gif) repeat-x;">:: INFORME DETALLADO DE PARADA</div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0">
      ...
      <tr>
        <td align="left"><strong>SELECCIONE NOMBRE DEL VEHICULO</strong></td>
        <td align="left">
		...
		else echo '<option value="0">- Seleccione Vehiculo -</option>';
...
<div style="width:100%; padding:5px; background:#ffffff;">
  ...
  <tr>
    <td colspan="6" bgcolor="#000000"><div style="color:#FFF; font-weight:bold; background:url(images/top_bg.gif) repeat-x;">:: INFORME DETALLADO DE PARADA</div></td>
  </tr>
    <tr>
