...
if(isset($Apagado))
{
	...
	?><script type="text/javascript"> if(confirm('Esta seguro que desea Apagar el Vehiculo?')){
		...
		window.location.href ="http://172.16.5.196:9090/sendsms?phone=<?php echo $vehicle; ?>&text=stop123456";  
	}else{
...
if(isset($Encendido))
{
	?><script type="text/javascript"> if(confirm('Esta seguro que desea Encender el Vehiculo?')){
			...
			window.location.href ="http://172.16.5.196:9090/sendsms?phone=<?php echo $vehicle; ?>&text=resume123456";  
	}else{
		location.href ="apagado.php";
	}
	     </script>
...
//header("Location: http://172.16.5.196:9090/sendsms?phone=$vehicle&text=resume123456");
  ...
  <tr>
    ...
    <table width="100%" border="0">
      ...
      <tr>
	    ...
	    echo '<input type="submit" name="Apagado" id="Apagado" value="Apagar Vehiculo"  />';
